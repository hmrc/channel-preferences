...
trait TestModels extends EitherValues {
  ...
  val navigationContext: NavigationContext = NavigationContext(Some(
    Map("returnUrl" -> "VYBxyuFWQBQZAGpe5tSgmw%3D%3D", "returnText" -> "+me3pS/cgiyhgR8ZIqlfH1WAccrhVkAUGQBqXubUoJs=")))
